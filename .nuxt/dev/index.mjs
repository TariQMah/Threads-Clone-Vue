globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, assertMethod, readBody, setCookie, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/h3/dist/index.mjs';
import { PrismaClient } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/@prisma/client/index.js';
import { createRenderer } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/devalue/index.js';
import { renderToString } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Volumes/Macintosh%20HD%20-%20Data%201/vue-nuxt/threads-clone/node_modules/radix3/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "bucketUrl": "https://oxfoictjjefpbsljplki.supabase.co/storage/v1/object/public/threads-clone-files/",
    "supabase": {
      "url": "https://oxfoictjjefpbsljplki.supabase.co",
      "key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im94Zm9pY3RqamVmcGJzbGpwbGtpIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTExODk1NzYsImV4cCI6MjAwNjc2NTU3Nn0.rTxy16MHNCl6W86oy-Ce8--7WYDDkoItVvKqW0Oj8Hw",
      "client": {
        "auth": {
...
const serverAssets = [{"baseName":"server","dir":"/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _On8uPH = defineEventHandler(async (event) => {
...
const _lazy_wT1POU = () => Promise.resolve().then(function () { return createPost$1; });
const _lazy_Y9Cl8J = () => Promise.resolve().then(function () { return _id_$3; });
const _lazy_84cAjL = () => Promise.resolve().then(function () { return getAllPosts$1; });
const _lazy_1FNJFM = () => Promise.resolve().then(function () { return likePost$1; });
const _lazy_0zkqpd = () => Promise.resolve().then(function () { return _id_$1; });
const _lazy_uBodEz = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/create-post', handler: _lazy_wT1POU, lazy: true, middleware: false, method: undefined },
  { route: '/api/delete-post/:id', handler: _lazy_Y9Cl8J, lazy: true, middleware: false, method: undefined },
  { route: '/api/get-all-posts', handler: _lazy_84cAjL, lazy: true, middleware: false, method: undefined },
  { route: '/api/like-post', handler: _lazy_1FNJFM, lazy: true, middleware: false, method: undefined },
  { route: '/api/unlike-post/:id', handler: _lazy_0zkqpd, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_uBodEz, lazy: true, middleware: false, method: undefined },
  { route: '/api/_supabase/session', handler: _On8uPH, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_uBodEz, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
