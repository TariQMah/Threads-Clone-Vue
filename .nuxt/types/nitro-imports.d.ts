declare global {
  const __buildAssetsURL: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nuxt/dist/core/runtime/nitro/paths')['buildAssetsURL']
  const __publicAssetsURL: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nuxt/dist/core/runtime/nitro/paths')['publicAssetsURL']
  ...
  const cachedEventHandler: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineAppConfig: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nuxt/dist/core/runtime/nitro/config')['defineAppConfig']
  const defineCachedEventHandler: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useAppConfig: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nitropack/dist/runtime')['useAppConfig']
  const useBase: typeof import('h3')['useBase']
  const useNitroApp: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nitropack/dist/runtime')['useStorage']
  const writeEarlyHints: typeof import('h3')['writeEarlyHints']
}
export { defineCachedFunction, defineCachedEventHandler, cachedFunction, cachedEventHandler, useRuntimeConfig, useStorage, useNitroApp, defineNitroPlugin, nitroPlugin, defineRenderHandler, getRouteRules, useAppConfig } from '/Volumes/Macintosh HD - Data 1/vue-nuxt/threads-clone/node_modules/nitropack/dist/runtime';
